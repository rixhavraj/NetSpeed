...
import { Download as DownloadIcon, History, Calendar, ChevronDown, ChevronUp } from 'lucide-react';
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-6">
          <AnimatePresence initial={false}>
            {(expanded ? versions : versions.slice(0, 1)).map((ver, index) => (
              <motion.div 
                key={ver.version} 
                ...
                className="glass-card rounded-2xl p-6 md:p-8 relative overflow-hidden group hover:border-white/10 transition-colors"
              >
        ...
        {versions.length > 1 && (
          <div className="mt-10 flex justify-center">
            <button 
              ...
              className="flex items-center gap-2 px-6 py-3 rounded-full glass hover:bg-white/10 text-white font-medium transition-colors border border-white/10"
            >
              {expanded ? (
                <>
                  <span>Show Less</span>
